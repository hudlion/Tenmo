...
public class App {
    ...
    private void sendBucks() {
        ...
        if (userInput == 0 || userInput == currentUser.getUser().getId()) {
            ...
            while (transferAmount.compareTo(tenmoService.getBalance(currentUser).getBalance()) == 1 || transferAmount.compareTo(BigDecimal.ZERO) <= 0) {

                if (transferAmount.compareTo(tenmoService.getBalance(currentUser).getBalance()) == 1) {
